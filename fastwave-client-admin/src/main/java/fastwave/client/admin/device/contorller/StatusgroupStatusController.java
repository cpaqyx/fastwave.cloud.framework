...
@RestController
@RequestMapping(value = {"/device/statusgroupStatus"}, produces="application/json;charset=UTF-8")
public class StatusgroupStatusController {
	@Autowired
	private StatusgroupStatusFeign statusgroupStatusFeignClient;
	...
	public Map<String, Object> list(@RequestBody Map<String, Object> params){
		Map<String, Object> reMap= this.statusgroupStatusFeignClient.list(params);
		return reMap;
	}
	...
	public Map<String, Object> get(@RequestBody Map<String, Object> params){
		Map<String, Object> reMap= this.statusgroupStatusFeignClient.view(params);
		return reMap;
	}
	...
	public R save(@RequestBody StatusgroupStatus statusgroupStatus){
		return statusgroupStatusFeignClient.save(statusgroupStatus);
	}
	...
	public R update(@RequestBody StatusgroupStatus statusgroupStatus){
		return statusgroupStatusFeignClient.update(statusgroupStatus);
	}
	...
	public R remove(@RequestBody Map<String, Object> params){
		return statusgroupStatusFeignClient.remove(params);
	}
}
