...
@RestController
@RequestMapping(value = {"/device/device"}, produces="application/json;charset=UTF-8")
public class DeviceController {
	@Autowired
	private DeviceFeign deviceFeignClient;
	...
	public Map<String, Object> list(@RequestBody Map<String, Object> params){
		Map<String, Object> reMap= this.deviceFeignClient.list(params);
		return reMap;
	}
	...
	public Map<String, Object> get(@RequestBody Map<String, Object> params){
		Map<String, Object> reMap= this.deviceFeignClient.view(params);
		return reMap;
	}
	...
	public R save(@RequestBody Device device){
		return deviceFeignClient.save(device);
	}
	...
	public R update(@RequestBody Device device){
		return deviceFeignClient.update(device);
	}
	...
	public R remove(@RequestBody Map<String, Object> params){
		return deviceFeignClient.remove(params);
	}
}
