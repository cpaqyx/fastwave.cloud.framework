...
@RestController
@RequestMapping(value = {"/video/equipment"}, produces="application/json;charset=UTF-8")
public class EquipmentController {
	@Autowired
	private EquipmentFeign equipmentFeignClient;
	...
	public Map<String, Object> list(@RequestBody Map<String, Object> params){
		Map<String, Object> reMap= this.equipmentFeignClient.list(params);
		return reMap;
	}
	...
	public Map<String, Object> get(@RequestBody Map<String, Object> params){
		Map<String, Object> reMap= this.equipmentFeignClient.view(params);
		return reMap;
	}
	...
	public R save(@RequestBody Equipment equipment){
		return equipmentFeignClient.save(equipment);
	}
	...
	public R update(@RequestBody Equipment equipment){
		return equipmentFeignClient.update(equipment);
	}
	...
	public R remove(@RequestBody Map<String, Object> params){
		return equipmentFeignClient.remove(params);
	}
}
