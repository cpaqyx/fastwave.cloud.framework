...
@RestController
@RequestMapping(value = {"/config/district"}, produces="application/json;charset=UTF-8")
public class DistrictController {
	@Autowired
	private DistrictFeign districtFeignClient;

	@PostMapping("/treelist")
	public Map<String, Object> treelist(@RequestBody Map<String, Object> params){
		return districtFeignClient.treelist(params);
	}
	...
	public Map<String, Object> list(@RequestBody Map<String, Object> params){
		Map<String, Object> reMap= this.districtFeignClient.list(params);
		return reMap;
	}
	...
	public Map<String, Object> get(@RequestBody Map<String, Object> params){
		Map<String, Object> reMap= this.districtFeignClient.view(params);
		return reMap;
	}
	...
	public R save(@RequestBody District district){
		return districtFeignClient.save(district);
	}
	...
	public R update(@RequestBody District district){
		return districtFeignClient.update(district);
	}
	...
	public R remove(@RequestBody Map<String, Object> params){
		return districtFeignClient.remove(params);
	}
}
